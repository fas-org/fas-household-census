...
class LongTermWorkers(models.Model):
    ...
    agricultural_labor = models.CharField(max_length=100,db_column='Agri-cultural labour', blank=True, null=True)
    operating_machines = models.CharField(max_length=100, db_column='Operating machines', blank=True, null=True)
    tending_animals = models.CharField(max_length=100,db_column='Tending animals', blank=True, null=True)
    non_agri_business = models.CharField(max_length=100,db_column='Non-agricultural businesses', blank=True, null=True)
    domestic_work = models.CharField(max_length=100, db_column='Domestic work', blank=True, null=True)
...
class NonAgricultureWorkers(models.Model):
    ...
    wage_form = models.CharField(max_length=100,db_column='Wage form', blank=True, null=True)
