...
class IncomeFromStateAndCommonPropertyResources(models.Model):
    ...
    item_collected = models.CharField(max_length=100, db_column='Item collected',blank=True, null=True)
    name_of_worker = models.IntegerField(db_column='Name of worker', max_length=50, blank=True, null=True)
    ...
    where_marketed = models.CharField(db_column='Where marketed', max_length=100, blank=True, null=True)
    marketing_agency = models.CharField(db_column='Marketing agency', max_length=100, blank=True, null=True)
...
class AgriculturalOrNonAgriculturalLabourServices(models.Model):
    ...
    caste_of_employer = models.CharField(max_length=100, db_column='caste of employer', blank=True, null=True)
