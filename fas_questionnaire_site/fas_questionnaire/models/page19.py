...
class PublicDistributionSystem(models.Model):
    ...
    no_of_adults_on_card = models.IntegerField(max_length=5, blank=True, null=True)
    no_of_children_on_card = models.IntegerField(max_length=5, blank=True, null=True)
...
class WaterForDomesticUse(models.Model):
    ...
    time_to_source = models.IntegerField(max_length=10, blank=True, null=True)
    months_water_available = models.CharField(max_length=100, blank=True, null=True)
    drinking = models.ForeignKey('PurposeForWhichUsed', models.CASCADE, db_column='drinking', blank=True, null=True)
    cooking = models.ForeignKey('PurposeForWhichUsed', models.CASCADE, db_column='cooking', blank=True, null=True)
    bathing_or_cleaning = models.ForeignKey('PurposeForWhichUsed', models.CASCADE, db_column='bathing_or_cleaning', blank=True, null=True)
    for_animals = models.ForeignKey('PurposeForWhichUsed', models.CASCADE, db_column='for_animals', blank=True, null=True)
...
class Housing(models.Model):
    ...
    verandah_present = models.ForeignKey('VerandahPresent', models.CASCADE, db_column='verandah_present', blank=True, null=True)
    separate_kitchen = models.ForeignKey('SeparateKitchen', models.CASCADE, db_column='separate_kitchen', blank=True, null=True)
    additional_rooms = models.IntegerField(max_length=10, blank=True, null=True)
    ...
    if_provided_by_govt = models.ForeignKey('ProvidedByGovt', models.CASCADE, db_column='if_provided_by_govt', blank=True, null=True)
...
class VerandahPresent(models.Model):
    id = models.AutoField(primary_key=True)
    choice = models.CharField(max_length=50, unique=True)

    class Meta:
        managed = True
        db_table = 'verandah_present'

    def __str__(self):
        return self.choice


class SeparateKitchen(models.Model):
    id = models.AutoField(primary_key=True)
    choice = models.CharField(max_length=50, unique=True)

    class Meta:
        managed = True
        db_table = 'separate_kitchen'
...
class ProvidedByGovt(models.Model):
    id = models.AutoField(primary_key=True)
    choice = models.CharField(max_length=50, unique=True)

    class Meta:
        managed = True
        db_table = 'provided_by_govt'
