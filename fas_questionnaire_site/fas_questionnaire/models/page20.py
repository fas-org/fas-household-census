...
class OutstandingLoans(models.Model):
    ...
    source_of_borrowing = models.CharField(max_length=100,db_column='source of borrowing', blank=True, null=True)
    purpose_of_borrowing = models.CharField(max_length=100,db_column='purpose of borrowing', blank=True, null=True)
...
class LoansBorrowedLastYearAndRepaid(models.Model):
    ...
    collateral = models.CharField(db_column='collateral', max_length=50, blank=True, null=True)
    rate_of_interest = models.CharField(db_column='rate of interest', max_length=50, blank=True, null=True)
    month_when_fully_repaid = models.CharField(max_length=100,db_column='Month When Fully Repaid', blank=True, null=True)
...
class MembershipInSelfHelpGroups(models.Model):
    ...
    bank_ngo_to_which_the_group_is_linked = models.CharField(max_length=100,db_column='Bank Ngo To Which The Group is Linked', blank=True, null=True)
    period_of_membership = models.CharField(max_length=100,db_column='Period Of Membership', blank=True, null=True)
...
class DetailsOfBankPostofficeAccountOfTheHousehold(models.Model):
    ...
    name_of_bank_post_office = models.CharField(max_length=100,db_column='Name Of Bank Post Office', blank=True, null=True)
    type_of_account = models.CharField(max_length=100,db_column='Type Of Account', blank=True, null=True)
