...
class LandMortgagedIn(models.Model):
    ...
    caste_of_mortgagor = models.CharField(max_length=100, db_column='Caste of mortgagor', blank=True, null=True)
    occupation_of_mortgagor = models.CharField(max_length=100, db_column='Occupation of mortgagor', blank=True, null=True)
    ...
    interest_usufruct = models.CharField(max_length=100, db_column='Interest/usufruct', blank=True, null=True)
...
class LandMortgagedOut(models.Model):
    ...
    caste_of_mortgagee = models.CharField(max_length=100,db_column='Caste of mortgagee', blank=True, null=True)
    occupation_of_mortgagee = models.CharField(max_length=100, db_column='Occupation of mortgagee', blank=True, null=True)
    year_of_mortgage = models.CharField(db_column='Year of mortgage', max_length=50, blank=True, null=True)
    mortgage_period = models.CharField(db_column='Mortgage period', max_length=50, blank=True, null=True)
    mortgage_money = models.CharField(db_column='Mortgage money', max_length=50, blank=True, null=True)
    interest_usufruct = models.CharField(max_length=100, db_column='Interest/usufruct',blank=True, null=True)
...
class LandLeasedInOnShareRent(models.Model):
    ...
    registered_unregistered = models.CharField(max_length=100, db_column='Registered/unregistered', blank=True, null=True)
    seasonal_yearly_other = models.CharField(max_length=100, db_column='Seasonal/yearly/other', blank=True, null=True)
...
class LandLeasedOutOnShareRent(models.Model):
    ...
    caste_of_sharecropper = models.CharField(max_length=100,db_column='Caste of sharecropper', blank=True, null=True)
    occupation_of_sharecropper = models.CharField(db_column='Occupation of sharecropper', max_length=50, blank=True, null=True)
    registered_unregistered = models.CharField(max_length=100, db_column='Registered/unregistered', blank=True, null=True)
    seasonal_annual_other = models.CharField(max_length=100, db_column='Seasonal, annual, other', blank=True, null=True)
    year_of_lease = models.CharField(db_column='Year of lease', max_length=50, blank=True, null=True)
    percentage_share_of_crop = models.CharField(db_column='Percentage share of crop', max_length=50, blank=True, null=True)
