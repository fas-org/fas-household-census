...
def edit(request, pk):
    ...
    labour_days_employed_in_agricultural_operations_formset = modelformset_factory(LabourDaysEmployedInAgriculturalOperations, form=LabourDaysEmployedInAgriculturalOperationsForm, extra=5)
